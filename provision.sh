...
function addAndRunScript {
  ...
  #cd /e/Hari/Nexus/nexus-scripting-examples-master/nexus-scripting-examples-master/complex-script/apache-groovy-binary-3.0.4/groovy-3.0.4/bin
...
addAndRunScript createRepositoryMaven createRepositoryMaven.groovy
addAndRunScript createRepositoryDocker createRepositoryDocker.groovy
